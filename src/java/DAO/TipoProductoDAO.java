...
public class TipoProductoDAO implements CRUDTipoProducto {
    private static String sql_selectAll = "select * from tipo_producto";
    private static String sql_insert = "insert into tipo_producto (id_tipo_producto, categoria_tipo_producto) values(?, ?)";
    private static String sql_delete = "delete from tipo_producto where id_tipo_producto = ?";
    private static String sql_selectTipo_producto = "select * from tipo_producto where id_tipo_producto = ?";
    private static String sql_update = "update tipo_producto set categoria_tipo_producto = ? where id_tipo_producto = ?";
    ...
    public ArrayList<TipoProducto> listarTipoProducto() {
        ...
        try{
            ...
            while(rs.next()){
                ...
                objTipoProducto.setId_tipo_producto(rs.getInt("id_tipo_producto"));
    ...
    public List buscar(String texto) {
      ...
      String sql_search = "SELECT * FROM tipo_producto WHERE id_tipo_producto like '%"+texto+"%' or categoria_tipo_producto like '%"+texto+"%'";
