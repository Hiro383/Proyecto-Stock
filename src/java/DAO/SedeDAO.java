...
public class SedeDAO  implements CRUDSede{
    ...
    private static String sql_selectSede = "select * from sede where codigo_sede = ?";
    private static String sql_insert = "insert into sede (codigo_sede, nombre_sede, direccion_sede) values (?,?,?)";
    private static String sql_delete = "delete from sede where codigo_sede = ?";
    private static String sql_update = "update sede set nombre_sede = ?, direccion_sede = ? where codigo_sede = ?";
    ...
    public ArrayList<Sede> listSede() {
        ...
        try {
            ...
            while (rs.next()) {                
                ...
                objSede.setCodigo_sede(rs.getString("codigo_sede"));
    ...
    PreparedStatement psG;
        try {
            ...
            while (rs.next()) {                
                s.setCodigo_sede(rs.getString("codigo_sede"));
