...
<html lang="en">
    ...
    <%
        ...
        ConexionDB objCone = new ConexionDB();
            ...
            String codigo_producto = (String)objsesion.getAttribute("codigo_producto");
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group"id="fg_codigo_producto">
                                                            <input class="form-control py-4" id="txtCodigo_producto" name="txtCodigo_producto" type="text" placeholder="000" readonly=""  value="<%=objPro.getCodigo_producto()%>"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
